...
/**
 * Differs from goog.ui.ac.AutoComplete only in that it uses an
...
goog.inherits(grokdoc.IconifiedAutoComplete, goog.ui.ac.AutoComplete);
...
function load() {
  ...
  function toggleClass(classname, visible) {
    ...
    for (var i = 0; i < elts.length; i++) {
      goog.style.setElementShown(elts[i], visible);
    }
  }
